...
@section('script')
    ...
    <script src="js/moment.min.js"></script> <!--DATE FORMAT BEING USED BY DATERANGEPICKER-->
    <script src="js/daterangepicker.js"></script> <!--JS FOR MULTIPLE SELECT FORM INPUT-->
    <script src="js/bootstrap-datepicker.min.js"></script> <!--JS FOR DATE AND TIME RANGE-->
